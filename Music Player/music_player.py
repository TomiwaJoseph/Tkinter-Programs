...
class StartPage(Frame):
    def __init__(self,root):
        ...
        self.first_card = Frame(width=60,height=60,relief='ridge',bg='#101820',bd=2)
...
class MusicPage(Frame):
    def __init__(self,root):
        ...
        self.playlist_frame = Frame(width=630,height=350,relief='ridge',bg='#101820')
        self.about_app_frame = Frame(width=630,height=350,relief='ridge',bg='#101820')
        self.about_developer_frame = Frame(width=630,height=350,relief='ridge',bg='#101820')
        self.quitting_frame = Frame(width=630,height=350,relief='ridge',bg='#101820')
    ...
    def create_ui(self):
        ...
        self.album_art = Label(image=self.cover,relief='ridge',width=180,height=180)
        ...
        self.progress.place(relx=0.5,rely=0.72,anchor=CENTER)
        self.progress_start = Label(font='candara 14',fg='#f2aa4c',bg='#101820',text='5:00:00')
        self.progress_start.place(relx=0.09,rely=0.72,anchor=CENTER)
        self.progress_end = Label(font='candara 14',fg='#f2aa4c',bg='#101820',text='5:00:00')
        ...
        self.previous_btn = Button(image=self.prev_img,bd=0,command=self.previous_song,bg='#101820')
        ...
        self.play_btn = Button(image=self.play_img,bd=0,command=lambda:self.play_song('button press'),bg='#101820')
        ...
        self.next_btn = Button(image=self.next_img,bd=0,command=lambda:self.next_song('from button'),bg='#101820')
        ...
        self.repeat_all_btn = Button(image=self.view_playlist_img,bd=0,command=self.view_playlist,bg='#101820')
        ...
        self.repeat_all_btn = Button(image=self.repeat_all_img,bd=0,command=self.repeat_all_playlist,bg='#101820')
        ...
        self.repeat_one_btn = Button(image=self.repeat_one_img,bd=0,command=self.repeat_current_song,bg='#101820')
        ...
        self.shuffle_btn = Button(image=self.shuffle_img,bd=0,command=self.shuffle_playlist,bg='#101820')
        ...
        self.speaker_btn = Button(image=self.speaker_img,bd=0,command=self.mute_and_unmute_song,bg='#101820')
    ...
    def create_menubar(self):
        ...
        self.helpmenu.add_command(label='About Developer',command=self.about_developer,compound='left')
          
    def forwards_or_backwards(self, value):
        new_position = int(self.progress.get())
        self.current_time = new_position
        pygame.mixer.music.load(self.playlist_in_use[self.current_song_index_in_playlist])
    ...
    def about_app(self):
        ...
        back_button = Button(self.about_app_frame,image=self.back,bg="#fff",width=50,command=lambda:self.remove_frame('about_app'))
        back_button.place(x=20,y=15)
        about_text = '''\nWelcome music lover!\n\nSHORTCUTS\nCtrl+A -> Add songs\nCtrl+Q -> Quit app\nCtrl+L -> View playlist\nSpace -> Play or pause music
        \nEnjoy😎!
        '''
        the_label = Label(self.about_app_frame,text=about_text,fg='#f2aa4c',bg='#101820',font='montserrat 14')
    ...
    def view_playlist(self, event=None):
        ...
        back_button = Button(self.playlist_frame,image=self.back,bg="#fff",width=50,command=lambda:self.remove_frame('view_playlist'))
        back_button.place(x=20,y=15)
        ...
        try:
            ...
            lists.itemconfig(currently_playing_index, {'bg': '#101820', 'fg': 'white'})
        except IndexError:
    ...
    def about_developer(self):
        ...
        back_button = Button(self.about_developer_frame,image=self.back,bg="#fff",width=50,command=lambda:self.remove_frame('about_developer'))
        back_button.place(x=20,y=15)
        ...
        the_github = Entry(self.about_developer_frame,width=30, justify='center',font='montserrat 14')
        the_github.insert(0, "https://github.com/TomiwaJoseph")
        the_github.configure(fg='#f2aa4c',state="readonly",readonlybackground="#101820")
