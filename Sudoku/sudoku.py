...
class StartPage(Frame):
    def __init__(self,master):
        ...
        #======= Title =====================
        Label(self.master,text='Sudoku',font='poppins 50',fg='#505050',bg='#f2aa4c').place(x=75,y=63)
        Label(self.master,text='Sudoku',font='poppins 50',fg='#f2aa4c',bg='#101820').place(x=75,y=60)
         #=========== Buttons ==================
        self.start = Button(self.master,text='Start',width=8,font='poppins 14',bd=0,fg='#f2aa4c',bg='#101820',command=lambda:self.master.switch_frame(SelectDifficultyPage))
...
class EasyPage(Frame):
    ...
    def display_ui(self):
        #========= UI and stuff ===========
        self.row1col1 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row1col1.place(x=82, y=25)
        self.row1col2 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row1col2.place(x=140, y=25)
        self.row1col3 = Button(text='',command=lambda:self.change_numbers(self.row1col3),bg='white',fg='red',font='candara 22',width=3)
        self.row1col3.place(x=198, y=25)
        self.row1col4 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row1col4.place(x=256, y=25)

        self.row2col1 = Button(text='',command=lambda:self.change_numbers(self.row2col1),bg='white',fg='red',font='candara 22',width=3)
        self.row2col1.place(x=82, y=88)
        self.row2col2 = Button(text='',command=lambda:self.change_numbers(self.row2col2),bg='white',fg='red',font='candara 22',width=3)
        self.row2col2.place(x=140, y=88)
        self.row2col3 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row2col3.place(x=198, y=88)
        self.row2col4 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row2col4.place(x=256, y=88)

        self.row3col1 = Button(text='',command=lambda:self.change_numbers(self.row3col1),bg='white',fg='red',font='candara 22',width=3)
        self.row3col1.place(x=82, y=151)
        self.row3col2 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row3col2.place(x=140, y=151)
        self.row3col3 = Button(text='',command=lambda:self.change_numbers(self.row3col3),bg='white',fg='red',font='candara 22',width=3)
        self.row3col3.place(x=198, y=151)
        self.row3col4 = Button(text='',command=lambda:self.change_numbers(self.row3col4),bg='white',fg='red',font='candara 22',width=3)
        self.row3col4.place(x=256, y=151)

        self.row4col1 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row4col1.place(x=82, y=214)
        self.row4col2 = Button(text='',command=lambda:self.change_numbers(self.row4col2),bg='white',fg='red',font='candara 22',width=3)
        self.row4col2.place(x=140, y=214)
        self.row4col3 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row4col3.place(x=198, y=214)
        self.row4col4 = Button(text='',command=lambda:self.change_numbers(self.row4col4),bg='white',fg='red',font='candara 22',width=3)
...
class MyWierdVersion(Frame):
    def __init__(self,master):
        ...
        self.row1col2 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row1col2.place(x=140, y=25)
        self.row1col3 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row1col3.place(x=198, y=25)
        self.row1col4 = Button(text='',command=lambda:self.change_numbers(self.row1col4),bg='white',fg='red',font='candara 22',width=3)
        self.row1col4.place(x=256, y=25)
        self.row1col5 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row1col5.place(x=314, y=25)
        self.row1col6 = Button(text='',command=lambda:self.change_numbers(self.row1col6),bg='white',fg='red',font='candara 22',width=3)
        self.row1col6.place(x=372, y=25)
        
        self.row2col1 = Button(text='',command=lambda:self.change_numbers(self.row2col1),bg='white',fg='red',font='candara 22',width=3)
        self.row2col1.place(x=82, y=88)
        self.row2col2 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row2col2.place(x=140, y=88)
        self.row2col3 = Button(text='',command=lambda:self.change_numbers(self.row2col3),bg='white',fg='red',font='candara 22',width=3)
        self.row2col3.place(x=198, y=88)
        self.row2col4 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row2col4.place(x=256, y=88)
        self.row2col5 = Button(text='',command=lambda:self.change_numbers(self.row2col5),bg='white',fg='red',font='candara 22',width=3)
        self.row2col5.place(x=314, y=88)
        self.row2col6 = Button(text='',command=lambda:self.change_numbers(self.row2col6),bg='white',fg='red',font='candara 22',width=3)
        self.row2col6.place(x=372, y=88)
        
        self.row3col1 = Button(text='',command=lambda:self.change_numbers(self.row3col1),bg='white',fg='red',font='candara 22',width=3)
        self.row3col1.place(x=82, y=151)
        self.row3col2 = Button(text='',command=lambda:self.change_numbers(self.row3col2),bg='white',fg='red',font='candara 22',width=3)
        self.row3col2.place(x=140, y=151)
        self.row3col3 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row3col3.place(x=198, y=151)
        self.row3col4 = Button(text='',command=lambda:self.change_numbers(self.row3col4),bg='white',fg='red',font='candara 22',width=3)
        self.row3col4.place(x=256, y=151)
        self.row3col5 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row3col5.place(x=314, y=151)
        self.row3col6 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row3col6.place(x=372, y=151)
        
        self.row4col1 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row4col1.place(x=82, y=214)
        self.row4col2 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row4col2.place(x=140, y=214)
        self.row4col3 = Button(text='',command=lambda:self.change_numbers(self.row4col3),bg='white',fg='red',font='candara 22',width=3)
        self.row4col3.place(x=198, y=214)
        self.row4col4 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row4col4.place(x=256, y=214)
        self.row4col5 = Button(text='',command=lambda:self.change_numbers(self.row4col5),bg='white',fg='red',font='candara 22',width=3)
        self.row4col5.place(x=314, y=214)
        self.row4col6 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row4col6.place(x=372, y=214)

        self.row5col1 = Button(text='',command=lambda:self.change_numbers(self.row5col1),bg='white',fg='red',font='candara 22',width=3)
        self.row5col1.place(x=82, y=277)
        self.row5col2 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row5col2.place(x=140, y=277)
        self.row5col3 = Button(text='',command=lambda:self.change_numbers(self.row5col3),bg='white',fg='red',font='candara 22',width=3)
        self.row5col3.place(x=198, y=277)
        self.row5col4 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row5col4.place(x=256, y=277)
        self.row5col5 = Button(text='',command=lambda:self.change_numbers(self.row5col5),bg='white',fg='red',font='candara 22',width=3)
        self.row5col5.place(x=314, y=277)
        self.row5col6 = Button(text='',command=lambda:self.change_numbers(self.row5col6),bg='white',fg='red',font='candara 22',width=3)
        self.row5col6.place(x=372, y=277)
        
        self.row6col1 = Button(text='',command=lambda:self.change_numbers(self.row6col1),bg='white',fg='red',font='candara 22',width=3)
        self.row6col1.place(x=82, y=340)
        self.row6col2 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row6col2.place(x=140, y=340)
        self.row6col3 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
        self.row6col3.place(x=198, y=340)
        self.row6col4 = Button(text='',command=lambda:self.change_numbers(self.row6col4),bg='white',fg='red',font='candara 22',width=3)
        self.row6col4.place(x=256, y=340)
        self.row6col5 = Button(text='',command=lambda:self.change_numbers(self.row6col5),bg='white',fg='red',font='candara 22',width=3)
        self.row6col5.place(x=314, y=340)
        self.row6col6 = Button(text='',bg='white',fg='#101820',font='candara 22',width=3)
...
class ExtremePage(Frame):
    ...
    def display_ui(self):
        #========= UI and stuff ===========
        self.row1col1 = Button(text='',bg='white',fg='teal',font='candara 22',width=3)
        self.row1col1.place(x=82, y=25)
        self.row1col2 = Button(text='8',bg='white',fg='teal',font='candara 22',width=3)
        self.row1col2.place(x=140, y=25)
        self.row1col3 = Button(text='',command=lambda:self.change_numbers(self.row1col3),bg='white',fg='red',font='candara 22',width=3)
        self.row1col3.place(x=198, y=25)
        self.row1col4 = Button(text='4',bg='white',fg='teal',font='candara 22',width=3)
        self.row1col4.place(x=256, y=25)
        self.row1col5 = Button(text='',command=lambda:self.change_numbers(self.row1col5),bg='white',fg='red',font='candara 22',width=3)
        self.row1col5.place(x=314, y=25)
        self.row1col6 = Button(text='',command=lambda:self.change_numbers(self.row1col6),bg='white',fg='red',font='candara 22',width=3)
        self.row1col6.place(x=372, y=25)
        self.row1col7 = Button(text='1',bg='white',fg='teal',font='candara 22',width=3)
        self.row1col7.place(x=430, y=25)
        self.row1col8 = Button(text='2',bg='white',fg='teal',font='candara 22',width=3)
        self.row1col8.place(x=488, y=25)
        self.row1col9 = Button(text='',command=lambda:self.change_numbers(self.row1col9),bg='white',fg='red',font='candara 22',width=3)
        self.row1col9.place(x=546, y=25)

        self.row2col1 = Button(text='6',bg='white',fg='teal',font='candara 22',width=3)
        self.row2col1.place(x=82, y=88)
        self.row2col2 = Button(text='',command=lambda:self.change_numbers(self.row2col2),bg='white',fg='red',font='candara 22',width=3)
        self.row2col2.place(x=140, y=88)
        self.row2col3 = Button(text='',command=lambda:self.change_numbers(self.row2col3),bg='white',fg='red',font='candara 22',width=3)
        self.row2col3.place(x=198, y=88)
        self.row2col4 = Button(text='',command=lambda:self.change_numbers(self.row2col4),bg='white',fg='red',font='candara 22',width=3)
        self.row2col4.place(x=256, y=88)
        self.row2col5 = Button(text='',bg='white',fg='teal',font='candara 22',width=3)
        self.row2col5.place(x=314, y=88)
        self.row2col6 = Button(text='',bg='white',fg='teal',font='candara 22',width=3)
        self.row2col6.place(x=372, y=88)
        self.row2col7 = Button(text='',command=lambda:self.change_numbers(self.row2col7),bg='white',fg='red',font='candara 22',width=3)
        self.row2col7.place(x=430, y=88)
        self.row2col8 = Button(text='',command=lambda:self.change_numbers(self.row2col8),bg='white',fg='red',font='candara 22',width=3)
        self.row2col8.place(x=488, y=88)
        self.row2col9 = Button(text='9',bg='white',fg='teal',font='candara 22',width=3)
        ...
        self.row3col3 = Button(text='',command=lambda:self.change_numbers(self.row3col3),bg='white',fg='red',font='candara 22',width=3)
        self.row3col3.place(x=198, y=151)
        self.row3col4 = Button(text='6',bg='white',fg='teal',font='candara 22',width=3)
        self.row3col4.place(x=256, y=151)
        self.row3col5 = Button(text='',command=lambda:self.change_numbers(self.row3col5),bg='white',fg='red',font='candara 22',width=3)
        self.row3col5.place(x=314, y=151)
        self.row3col6 = Button(text='1',bg='white',fg='teal',font='candara 22',width=3)
        self.row3col6.place(x=372, y=151)
        self.row3col7 = Button(text='',command=lambda:self.change_numbers(self.row3col7),bg='white',fg='red',font='candara 22',width=3)
        self.row3col7.place(x=430, y=151)
        self.row3col8 = Button(text='',bg='white',fg='teal',font='candara 22',width=3)
        self.row3col8.place(x=488, y=151)
        self.row3col9 = Button(text='8',bg='white',fg='teal',font='candara 22',width=3)
        self.row3col9.place(x=546, y=151)

        self.row4col1 = Button(text='',command=lambda:self.change_numbers(self.row4col1),bg='white',fg='red',font='candara 22',width=3)
        self.row4col1.place(x=82, y=214)
        self.row4col2 = Button(text='',command=lambda:self.change_numbers(self.row4col2),bg='white',fg='red',font='candara 22',width=3)
        self.row4col2.place(x=140, y=214)
        self.row4col3 = Button(text='',bg='white',fg='teal',font='candara 22',width=3)
        self.row4col3.place(x=198, y=214)
        self.row4col4 = Button(text='',command=lambda:self.change_numbers(self.row4col4),bg='white',fg='red',font='candara 22',width=3)
        self.row4col4.place(x=256, y=214)
        self.row4col5 = Button(text='4',bg='white',fg='teal',font='candara 22',width=3)
        self.row4col5.place(x=314, y=214)
        self.row4col6 = Button(text='',command=lambda:self.change_numbers(self.row4col6),bg='white',fg='red',font='candara 22',width=3)
        self.row4col6.place(x=372, y=214)
        self.row4col7 = Button(text='2',bg='white',fg='teal',font='candara 22',width=3)
        self.row4col7.place(x=430, y=214)
        self.row4col8 = Button(text='6',bg='white',fg='teal',font='candara 22',width=3)
        self.row4col8.place(x=488, y=214)
        self.row4col9 = Button(text='',command=lambda:self.change_numbers(self.row4col9),bg='white',fg='red',font='candara 22',width=3)
        self.row4col9.place(x=546, y=214)

        self.row5col1 = Button(text='',command=lambda:self.change_numbers(self.row5col1),bg='white',fg='red',font='candara 22',width=3)
        self.row5col1.place(x=82, y=277)
        self.row5col2 = Button(text='',command=lambda:self.change_numbers(self.row5col2),bg='white',fg='red',font='candara 22',width=3)
        self.row5col2.place(x=140, y=277)
        self.row5col3 = Button(text='1',bg='white',fg='teal',font='candara 22',width=3)
        self.row5col3.place(x=198, y=277)
        self.row5col4 = Button(text='',command=lambda:self.change_numbers(self.row5col4),bg='white',fg='red',font='candara 22',width=3)
        self.row5col4.place(x=256, y=277)
        self.row5col5 = Button(text='',bg='white',fg='teal',font='candara 22',width=3)
        self.row5col5.place(x=314, y=277)
        self.row5col6 = Button(text='',command=lambda:self.change_numbers(self.row5col6),bg='white',fg='red',font='candara 22',width=3)
        self.row5col6.place(x=372, y=277)
        self.row5col7 = Button(text='9',bg='white',fg='teal',font='candara 22',width=3)
        self.row5col7.place(x=430, y=277)
        self.row5col8 = Button(text='3',bg='white',fg='teal',font='candara 22',width=3)
        self.row5col8.place(x=488, y=277)
        self.row5col9 = Button(text='',command=lambda:self.change_numbers(self.row5col9),bg='white',fg='red',font='candara 22',width=3)
        self.row5col9.place(x=546, y=277)

        self.row6col1 = Button(text='9',bg='white',fg='teal',font='candara 22',width=3)
        self.row6col1.place(x=82, y=340)
        self.row6col2 = Button(text='',command=lambda:self.change_numbers(self.row6col2),bg='white',fg='red',font='candara 22',width=3)
        self.row6col2.place(x=140, y=340)
        self.row6col3 = Button(text='4',bg='white',fg='teal',font='candara 22',width=3)
        self.row6col3.place(x=198, y=340)
        self.row6col4 = Button(text='',command=lambda:self.change_numbers(self.row6col4),bg='white',fg='red',font='candara 22',width=3)
        self.row6col4.place(x=256, y=340)
        self.row6col5 = Button(text='6',bg='white',fg='teal',font='candara 22',width=3)
        self.row6col5.place(x=314, y=340)
        self.row6col6 = Button(text='',command=lambda:self.change_numbers(self.row6col6),bg='white',fg='red',font='candara 22',width=3)
        self.row6col6.place(x=372, y=340)
        self.row6col7 = Button(text='',command=lambda:self.change_numbers(self.row6col7),bg='white',fg='red',font='candara 22',width=3)
        self.row6col7.place(x=430, y=340)
        self.row6col8 = Button(text='',command=lambda:self.change_numbers(self.row6col8),bg='white',fg='red',font='candara 22',width=3)
        self.row6col8.place(x=488, y=340)
        self.row6col9 = Button(text='',bg='white',fg='teal',font='candara 22',width=3)
        self.row6col9.place(x=546, y=340)

        self.row7col1 = Button(text='',command=lambda:self.change_numbers(self.row7col1),bg='white',fg='red',font='candara 22',width=3)
        self.row7col1.place(x=82, y=403)
        self.row7col2 = Button(text='',bg='white',fg='teal',font='candara 22',width=3)
        self.row7col2.place(x=140, y=403)
        self.row7col3 = Button(text='',command=lambda:self.change_numbers(self.row7col3),bg='white',fg='red',font='candara 22',width=3)
        self.row7col3.place(x=198, y=403)
        self.row7col4 = Button(text='3',bg='white',fg='teal',font='candara 22',width=3)
        self.row7col4.place(x=256, y=403)
        self.row7col5 = Button(text='',command=lambda:self.change_numbers(self.row7col5),bg='white',fg='red',font='candara 22',width=3)
        self.row7col5.place(x=314, y=403)
        self.row7col6 = Button(text='',command=lambda:self.change_numbers(self.row7col6),bg='white',fg='red',font='candara 22',width=3)
        self.row7col6.place(x=372, y=403)
        self.row7col7 = Button(text='',command=lambda:self.change_numbers(self.row7col7),bg='white',fg='red',font='candara 22',width=3)
        self.row7col7.place(x=430, y=403)
        self.row7col8 = Button(text='1',bg='white',fg='teal',font='candara 22',width=3)
        self.row7col8.place(x=488, y=403)
        self.row7col9 = Button(text='2',bg='white',fg='teal',font='candara 22',width=3)
        self.row7col9.place(x=546, y=403)

        self.row8col1 = Button(text='1',bg='white',fg='teal',font='candara 22',width=3)
        self.row8col1.place(x=82, y=466)
        self.row8col2 = Button(text='2',bg='white',fg='teal',font='candara 22',width=3)
        self.row8col2.place(x=140, y=466)
        self.row8col3 = Button(text='',command=lambda:self.change_numbers(self.row8col3),bg='white',fg='red',font='candara 22',width=3)
        self.row8col3.place(x=198, y=466)
        self.row8col4 = Button(text='',command=lambda:self.change_numbers(self.row8col4),bg='white',fg='red',font='candara 22',width=3)
        self.row8col4.place(x=256, y=466)
        self.row8col5 = Button(text='',command=lambda:self.change_numbers(self.row8col5),bg='white',fg='red',font='candara 22',width=3)
        self.row8col5.place(x=314, y=466)
        self.row8col6 = Button(text='',bg='white',fg='teal',font='candara 22',width=3)
        self.row8col6.place(x=372, y=466)
        self.row8col7 = Button(text='4',bg='white',fg='teal',font='candara 22',width=3)
        self.row8col7.place(x=430, y=466)
        self.row8col8 = Button(text='',command=lambda:self.change_numbers(self.row8col8),bg='white',fg='red',font='candara 22',width=3)
        self.row8col8.place(x=488, y=466)
        self.row8col9 = Button(text='',command=lambda:self.change_numbers(self.row8col9),bg='white',fg='red',font='candara 22',width=3)
        self.row8col9.place(x=546, y=466)

        self.row9col1 = Button(text='',command=lambda:self.change_numbers(self.row9col1),bg='white',fg='red',font='candara 22',width=3)
        self.row9col1.place(x=82, y=529)
        self.row9col2 = Button(text='4',bg='white',fg='teal',font='candara 22',width=3)
        self.row9col2.place(x=140, y=529)
        self.row9col3 = Button(text='9',bg='white',fg='teal',font='candara 22',width=3)
        self.row9col3.place(x=198, y=529)
        self.row9col4 = Button(text='2',bg='white',fg='teal',font='candara 22',width=3)
        self.row9col4.place(x=256, y=529)
        self.row9col5 = Button(text='',command=lambda:self.change_numbers(self.row9col5),bg='white',fg='red',font='candara 22',width=3)
        self.row9col5.place(x=314, y=529)
        self.row9col6 = Button(text='6',bg='white',fg='teal',font='candara 22',width=3)
        self.row9col6.place(x=372, y=529)
        self.row9col7 = Button(text='',command=lambda:self.change_numbers(self.row9col7),bg='white',fg='red',font='candara 22',width=3)
        self.row9col7.place(x=430, y=529)
        self.row9col8 = Button(text='',command=lambda:self.change_numbers(self.row9col8),bg='white',fg='red',font='candara 22',width=3)
        self.row9col8.place(x=488, y=529)
        self.row9col9 = Button(text='',bg='white',fg='teal',font='candara 22',width=3)
