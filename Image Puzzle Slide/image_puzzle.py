...
class StartPage(Frame):
    ...
    def __init__(self, root):
        ...
        self.bg = self.bg.resize((485, 485), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
        self.picture_frame = Frame(
            self.master, width=500, height=500, relief='ridge', bg='#143d59', bd=5)
...
class SettingsPage(Frame):
    ...
    def __init__(self, root):
        ...
        self.settings_frame = Frame(
            self.master, width=600, height=230, relief='ridge', bg='#143d59', bd=5)
...
class MainPage(Frame):
    ...
    def __init__(self, root):
        ...
        Button(image=self.back, bg="#fff", width=50,
               command=self.go_back_to_settings).place(x=60, y=20)
        # =========== Game Area ================
        self.picture_frame = Frame(
            self.master, width=600, height=600, relief='ridge', bg='#143d59', bd=5)
    ...
    def help(self):
        ...
        if getattr(self, '_img_help_id', None) is None:
            ...
            self._img_help_id = self.canvas.create_image(
                0, 0, image=self._img_help, anchor=NW)
        else:
...
if __name__ == '__main__':
    ...
    # Fullscreen without minimize and maximize button
