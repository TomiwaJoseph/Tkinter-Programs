...
<!-- Each folder contain a windows executable file (.exe) to download and install for use on your computer. Enjoy! -->
...
- Multiple captures is mandatory (as per naija checkers rules)
- others...
...
- Playlist view
- Shortcuts for easy user experience...
- ...and more
- In short, it works.
- Enjoy!
...
A simple image viewer and timer for figure artists like me who might like to have timed drawing sessions. Its working is simple:
