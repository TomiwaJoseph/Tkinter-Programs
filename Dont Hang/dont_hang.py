...
class MainPage(Frame):
    def __init__(self,root):
        ...
        #======= Guess buttons =================
        self.l1 = Button(text='',font='candara 32',bd=0,width=2,fg='green',bg='white')
        self.l1.place(x=120,y=40)
        self.l2 = Button(text='',font='candara 32',bd=0,width=2,fg='green',bg='white')
        self.l2.place(x=180,y=40)
        self.l3 = Button(text='',font='candara 32',bd=0,width=2,fg='green',bg='white')
        self.l3.place(x=240,y=40)
        self.l4 = Button(text='',font='candara 32',bd=0,width=2,fg='green',bg='white')
        self.l4.place(x=300,y=40)
        self.l5 = Button(text='',font='candara 32',bd=0,width=2,fg='green',bg='white')
        self.l5.place(x=360,y=40)
        self.l6 = Button(text='',font='candara 32',bd=0,width=2,fg='green',bg='white')
        self.l6.place(x=420,y=40)
        self.l7 = Button(text='',font='candara 32',bd=0,width=2,fg='green',bg='white')
        self.l7.place(x=480,y=40)
        self.l8 = Button(text='',font='candara 32',bd=0,width=2,fg='green',bg='white')
        self.l8.place(x=540,y=40)
        #======= Game play buttons ============
        self.show = Button(text='Show Letter',font='candara 18',width=10,bd=0,fg='white',bg='cadetblue',command=self.hint_them)
        self.show.place(x=60,y=145)
        self.showScore = Label(font='candara 18',text='Your score -> 0',bg='cadetblue',fg='white')
    ...
    def show_keyboard(self):
        self.q = Button(text='Q',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('Q'))
        self.q.place(x=60,y=200)
        self.w = Button(text='W',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('W'))
        self.w.place(x=120,y=200)
        self.e = Button(text='E',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('E'))
        self.e.place(x=180,y=200)
        self.r = Button(text='R',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('R'))
        self.r.place(x=240,y=200)
        self.t = Button(text='T',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('T'))
        self.t.place(x=300,y=200)
        self.y = Button(text='Y',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('Y'))
        self.y.place(x=360,y=200)
        self.u = Button(text='U',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('U'))
        self.u.place(x=420,y=200)
        self.i = Button(text='I',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('I'))
        self.i.place(x=480,y=200)
        self.o = Button(text='O',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('O'))
        self.o.place(x=540,y=200)
        self.p = Button(text='P',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('P'))
        self.p.place(x=600,y=200)

        self.a = Button(text='A',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('A'))
        self.a.place(x=80,y=300)
        self.s = Button(text='S',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('S'))
        self.s.place(x=140,y=300)
        self.d = Button(text='D',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('D'))
        self.d.place(x=200,y=300)
        self.f = Button(text='F',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('F'))
        self.f.place(x=260,y=300)
        self.g = Button(text='G',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('G'))
        self.g.place(x=320,y=300)
        self.h = Button(text='H',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('H'))
        self.h.place(x=380,y=300)
        self.j = Button(text='J',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('J'))
        self.j.place(x=440,y=300)
        self.k = Button(text='K',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('K'))
        self.k.place(x=500,y=300)
        self.l = Button(text='L',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('L'))
        self.l.place(x=560,y=300)

        self.z = Button(text='Z',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('Z'))
        self.z.place(x=140,y=400)
        self.x = Button(text='X',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('X'))
        self.x.place(x=200,y=400)
        self.c = Button(text='C',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('C'))
        self.c.place(x=260,y=400)
        self.v = Button(text='V',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('V'))
        self.v.place(x=320,y=400)
        self.b = Button(text='B',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('B'))
        self.b.place(x=380,y=400)
        self.n = Button(text='N',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('N'))
        self.n.place(x=440,y=400)
        self.m = Button(text='M',font='candara 32',bd=0,width=2,activebackground='black',activeforeground='white',fg='white',bg='#222',command=lambda: self.main_logic('M'))
    ...
    def hint_them(self):
        agree_to_hint = messagebox.askyesno('Show?',f'Are you sure?\nThis will cost you 5 score points')
        if agree_to_hint:
            for i in range(1):
                if self.l1['text'] == '':
                    self.score -= 5
