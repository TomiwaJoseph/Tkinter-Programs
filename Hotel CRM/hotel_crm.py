...
all_tables_are_created = cur.execute(
...
class StartPage(Frame):
    def __init__(self, root):
        ...
        self.bcg = self.bcg.resize((120, 100), Image.LANCZOS)
        self.bcg = ImageTk.PhotoImage(self.bcg)
        self.bcg_image = Label(self.master, image=self.bcg, bg='#fff').place(
            anchor=CENTER, relx=0.5, rely=0.38)
        # ======= Hotel Name =====================
        Label(self.master, text='SERENITY', font='garamond 40',
              fg='#505050', bg='teal').place(anchor=CENTER, relx=0.5, rely=0.483)
        Label(self.master, text='SERENITY', font='garamond 40', fg='teal',
              bg='#fff').place(anchor=CENTER, relx=0.5, rely=0.48)
        Label(self.master, text='HOTEL AND RESORTS', font='montserrat 16',
              fg='orangered', bg='#fff').place(anchor=CENTER, relx=0.5, rely=0.56)
        # =========== Buttons ==================
...
class AdminLogin(Frame):
    def __init__(self, root):
        ...
        self.bcg = ImageTk.PhotoImage(self.bcg)
        self.bcg_image = Label(self.master, image=self.bcg, bg='#fff').place(
            anchor=CENTER, relx=0.5, rely=0.36)
        # ======= Hotel Name =====================
        Label(self.master, text='SERENITY', font='garamond 40',
              fg='#505050', bg='teal').place(anchor=CENTER, relx=0.5, rely=0.463)
        Label(self.master, text='SERENITY', font='garamond 40', fg='teal',
              bg='#fff').place(anchor=CENTER, relx=0.5, rely=0.46)
        Label(self.master, text='HOTEL AND RESORTS', font='montserrat 16',
              fg='orangered', bg='#fff').place(anchor=CENTER, relx=0.5, rely=0.54)
        # ====== Variables =============
        ...
        self.pasEnter.bind(
            '<Return>', lambda dummy=0: self.check_credentials())
...
class AdminHotelCRM(Frame):
    def __init__(self, root):
        ...
        # =========== Top Bar ==========
        self.hotel_name_frame = Frame(
            self.master, width=1300, height=80, relief='ridge', bg='#fff', bd=5)
        self.hotel_name_frame.place(anchor=CENTER, relx=0.5, rely=0.09)
        self.utils = Frame(self.master, width=1300, height=600,
                           relief='ridge', bg='#fff', bd=5)
        self.utils.place(anchor=CENTER, relx=0.5, rely=0.56)
        # ======= Hotel Logo ===============
        self.bg = Image.open('./images/hotel_logo.PNG')
        self.bg = self.bg.resize((80, 60), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
        self.bg_image = Label(self.master, image=self.bg,
                              bg='#fff').place(x=240, y=35)
        ...
        self.staff_details_update_status = Label(
            self.staffs_frame, font='montserrat 18', bg='cornsilk')
        # ======== Other variables ================
        self.buttons = [self.status, self.rooms, self.staffs]
        self.all_frames = [self.status_frame, self.staffs_frame,
                           self.rooms_frame, self.staff_details_update_status]
    ...
    def status_section(self):
        ...
        hotel_info_form_frame = Frame(
            self.status_frame, width=750, height=230, relief='ridge', bg='cornsilk', bd=3)
        ...
        self.update_status = Label(
            self.status_frame, font='montserrat 16', bg='cornsilk')
    ...
    def save_hotel_status_edit(self):
        ...
        try:
            int_room, int_staff = int(
                admin_total_rooms), int(admin_staff_number)
            ...
            self.update_status.config(
                text='Hotel details successfully upadated.', fg='green')
            self.update_status.place(anchor=CENTER, relx=0.5, rely=0.2)
        except ValueError:
            self.update_status.config(
                text='Wrong input. Check and correct them.', fg='#dd4735')
            self.update_status.place(anchor=CENTER, relx=0.5, rely=0.2)
    ...
    def rooms_section(self):
        ...
        for customer in customer_query:
            ...
            self.expired_rooms[customer_key] = [
                customer[0], customer[1], customer[3], customer[4], customer[5], customer[6]]
        ...
        for y_coord in y_coordinates:
            for x_coord in x_coordinates:
                ...
                but.config(
                    command=lambda but=button_count: self.show_room_details(but))
                but.place(x=x_coord, y=y_coord)
                button_count += 1

        show_room_details = Frame(
            self.rooms_frame, width=750, height=250, relief='ridge', bg='cornsilk', bd=3)
        ...
        self.show_room_id = Label(
            show_room_details, bg='cornsilk', fg='#dd4735')
        self.show_current_occupant = Label(
            show_room_details, font='montserrat 16', bg='cornsilk', fg='teal')
        self.show_dates = Label(
            show_room_details, font='montserrat 16', bg='cornsilk', fg='teal')
        self.payment_meth = Label(
            show_room_details, font='montserrat 16', bg='cornsilk', fg='teal')
    ...
    def set_room_to_available(self):
        ...
        hotel_status_query = cur.execute(
            f"SELECT available_rooms FROM Hotel_Details").fetchone()
    ...
    def show_room_details(self, btn):
        ...
        if get_room_from_expired_rooms != None:
            ...
            occupant = get_room_from_expired_rooms[0] + \
                ' ' + get_room_from_expired_rooms[1]
            ...
            self.show_room_id.config(
                text=f'Room NO: {btn}', font='montserrat 18 bold')
            ...
            self.show_dates.config(
                text=f'From: {date_logged} To: {expired_date}')
    ...
    def staffs_section(self):
        ...
        # ========= Hotel information form ===========
        staff_details_query = cur.execute(
            f"SELECT staff_name, staff_extension, staff_email FROM Staff_Details").fetchall()
    ...
    def save_hotel_staff_details(self):
        names = [self.manager_name_edit.get(), self.chef_name_edit.get(
        ), self.room_service_name_edit.get(), self.customer_service_name_edit.get()]
        extension = [self.manager_ext_edit.get(), self.chef_ext_edit.get(
        ), self.room_service_ext_edit.get(), self.customer_service_ext_edit.get()]
        email = [self.manager_email_edit.get(), self.chef_email_edit.get(
        ), self.room_service_email_edit.get(), self.customer_service_email_edit.get()]
        ...
        self.staff_details_update_status.config(
            text='Staff details successfully updated.', fg='green')
        self.staff_details_update_status.place(
    ...
    def display_sidebar(self):
        ...
        self.status_img = self.status_img.resize((50, 50), Image.LANCZOS)
        ...
        self.rooms_img = self.rooms_img.resize((50, 50), Image.LANCZOS)
        ...
        self.staff_img = self.staff_img.resize((50, 50), Image.LANCZOS)
        ...
        self.logout_img = self.logout_img.resize((50, 50), Image.LANCZOS)
...
class HotelCRM(Frame):
    def __init__(self, root):
        ...
        self.reservation_message = Label(
            self.reservation_frame, font='montserrat 16', bg='cornsilk')
        self.buttons = [self.reserve, self.status,
                        self.contacts, self.rooms, self.filter]
    ...
    def display_sidebar(self):
        ...
        self.filter_img = self.filter_img.resize((50, 50), Image.LANCZOS)
        ...
        self.reserve_img = self.reserve_img.resize((50, 50), Image.LANCZOS)
        ...
        self.contact_img = self.contact_img.resize((50, 50), Image.LANCZOS)
    ...
    def reservation_section(self):
        ...
        reservation_form_frame = Frame(
            self.reservation_frame, width=750, height=450, relief='ridge', bg='cornsilk', bd=3)
        ...
        self.first_name = Entry(
            reservation_form_frame, bg='#dadada', fg='#222', font='montserrat 12', width=19)
        self.first_name.insert(0, 'First Name *')
        self.first_name.place(x=27, y=60)
        self.middle_name = Entry(
            reservation_form_frame, bg='#dadada', fg='#222', font='montserrat 12', width=19)
        ...
        self.email = Entry(reservation_form_frame, bg='#dadada',
                           fg='#222', font='montserrat 12', width=19)
        self.email.insert(0, 'Email *')
        self.email.place(x=267, y=150)
        self.address = Entry(reservation_form_frame, bg='#dadada',
                             fg='#222', font='montserrat 12', width=19)
    ...
    def reserve_it(self):
        ...
        room_is_available = cur.execute(
            f"SELECT room_status from Room_Details where id='{room_no}'").fetchone()
        ...
        try:
            ...
            avail = cur.execute(
                "SELECT available_rooms, total_customers from Hotel_Details").fetchone()
            value = int(avail[0]) - 1
    ...
    def rooms_section(self):
        ...
        self.rooms_frame.place(x=365, y=15)
        # ======= Variables ==========
        self.hotel_rooms_query = cur.execute(
            f"SELECT * FROM Room_Details").fetchall()
        x_coordinates = [67, 217, 367, 517, 667]
        ...
        for y_coord in y_coordinates:
            for x_coord in x_coordinates:
                ...
                but.config(
                    command=lambda but=button_count: self.fetch_room_details(but))
                but.place(x=x_coord, y=y_coord)

        show_room_details = Frame(
            self.rooms_frame, width=750, height=200, relief='ridge', bg='cornsilk', bd=3)
        ...
        self.show_tv = Label(
            show_room_details, font='montserrat 16', bg='cornsilk', fg='teal')
        self.show_wifi = Label(
            show_room_details, font='montserrat 16', bg='cornsilk', fg='teal')
        self.show_price = Label(show_room_details, bg='cornsilk', fg='teal')
        self.show_status = Label(
            show_room_details, font='montserrat 16', bg='cornsilk')
        self.show_unavailability = Label(
            show_room_details, font='montserrat 16', bg='cornsilk')
    ...
    def fetch_room_details(self, button):
        ...
        if room_available == 'AVAILABLE':
            self.show_room_id.config(
                text=f'Room NO: {button}', font='montserrat 18 bold')
            ...
            self.show_unavailability.config(
                text="UNAVAILABLE", font='montserrat 36', fg='#dd4735')
    ...
    def filter_section(self):
        ...
        # ========= Filter form ===========
        filter_form_frame = Frame(
            self.filter_frame, width=750, height=260, relief='ridge', bg='cornsilk', bd=3)
        ...
        self.show_filter_results = Frame(
            self.filter_frame, width=750, height=150, relief='ridge', bg='cornsilk', bd=3)
    ...
    def find_it(self):
        ...
        if data:
            for i in range(len(data)):
                ...
                but.place(x=joined_coordinates[i]
                          [0], y=joined_coordinates[i][1])
        else:
    ...
    def contacts_section(self):
        ...
        self.manager_img = self.manager_img.resize((80, 90), Image.LANCZOS)
        ...
        manager_frame = Frame(self.contacts_frame, width=255,
                              height=90, relief='ridge', bg='cornsilk', bd=0)
        ...
        self.chef_img = self.chef_img.resize((80, 90), Image.LANCZOS)
        ...
        restaurant_frame = Frame(
            self.contacts_frame, width=255, height=90, relief='ridge', bg='cornsilk', bd=0)
        ...
        self.room_img = self.room_img.resize((80, 90), Image.LANCZOS)
        ...
        self.customer_img = self.customer_img.resize((80, 90), Image.LANCZOS)
...
if __name__ == '__main__':
    ...
    # Fullscreen without close and minimize option
